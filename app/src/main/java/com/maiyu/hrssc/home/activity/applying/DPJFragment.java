...
import com.maiyu.hrssc.home.activity.applying.adapter.DPJPageAdapter;
 ...
 * 申请 待评价
 */
public class DPJFragment extends Fragment implements OnRefreshListener, OnLoadMoreListener {
    ...
    private DPJPageAdapter mAdapter;

    public DPJFragment() {
        // Required empty public constructor
    }

    public static DPJFragment newInstance(int param1) {
        DPJFragment fragment = new DPJFragment();
    ...
    private void initView() {
        ...
        // 设置列表
        mAdapter = new DPJPageAdapter(getActivity());
    ...
    private void initData() {
        ...
        if (4 == mParam1) {
            list.add(new Apply("劳动合同", "待评价", "2017-2-22 : 14:00"));
            list.add(new Apply("保密协议", "待评价", "2017-2-22 : 14:00"));
            list.add(new Apply("薪资证明", "待评价", "2017-2-22 : 14:00"));
