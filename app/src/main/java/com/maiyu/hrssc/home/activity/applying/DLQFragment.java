...
public class DLQFragment extends Fragment implements OnRefreshListener, OnLoadMoreListener {
    ...
    private void initView() {
        ...
        // 设置列表
        mAdapter = new DLQPageAdapter(getActivity());
    ...
    private void initData() {
        ...
        if (3 == mParam1) {
            list.add(new Apply("劳动合同", "待领取", "2017-2-22 : 14:00"));
            list.add(new Apply("保密协议", "待领取", "2017-2-22 : 14:00"));
            list.add(new Apply("薪资证明", "待领取", "2017-2-22 : 14:00"));
