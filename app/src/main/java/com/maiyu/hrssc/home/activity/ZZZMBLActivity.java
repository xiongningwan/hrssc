 ...
 * 在职证明
 */
public class ZZZMBLActivity extends BaseActivity {
    ...
    public void initViews() {
        mHeadView.setTitle("在职证明办理", true, true);
        ...
        rightButtonText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              //  Toast.makeText(XZZMBLActivity.this, "提交", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(ZZZMBLActivity.this, SucceedActivity.class));
            }
        });
    }
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(R.string.permission_dialog_ok, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(ZZZMBLActivity.this, new String[]{permission}, requestCode);
                        }
                    })
