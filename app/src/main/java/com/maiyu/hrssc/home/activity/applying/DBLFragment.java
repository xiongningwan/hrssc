...
import com.maiyu.hrssc.home.activity.applying.adapter.DBLPageAdapter;
 ...
 * 申请 待办理
 */
public class DBLFragment extends Fragment implements OnRefreshListener, OnLoadMoreListener {
    ...
    private DBLPageAdapter mAdapter;

    public DBLFragment() {
        // Required empty public constructor
    }

    public static DBLFragment newInstance(int param1) {
        DBLFragment fragment = new DBLFragment();
    ...
    private void initView() {
        ...
        // 设置列表
        mAdapter = new DBLPageAdapter(getActivity());
    ...
    private void initData() {
        ...
        if (2 == mParam1) {
            list.add(new Apply("劳动合同", "待办理", "2017-2-22 : 14:00"));
            list.add(new Apply("保密协议", "待办理", "2017-2-22 : 14:00"));
            list.add(new Apply("薪资证明", "待办理", "2017-2-22 : 14:00"));
