 ...
 * 计划生育
 */
public class JHSYBLActivity extends BaseActivity {
    ...
    public void initViews() {
        mHeadView.setTitle("计划生育证明办理", true, true);
        ...
        rightButtonText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              //  Toast.makeText(XZZMBLActivity.this, "提交", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(JHSYBLActivity.this, SucceedActivity.class));
            }
        });
    }
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(R.string.permission_dialog_ok, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(JHSYBLActivity.this, new String[]{permission}, requestCode);
                        }
                    })
