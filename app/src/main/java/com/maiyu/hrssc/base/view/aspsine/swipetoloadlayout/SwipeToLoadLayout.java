package com.maiyu.hrssc.base.view.aspsine.swipetoloadlayout;
    ...
    protected void onFinishInflate() {
        ...
        if (childNum == 0) {
            ...
            for (int i = 0; i < getChildCount(); i++) {
                ...
                if ("swipe_target".equals(view.getTag())) {
                    mTargetView = view;
                    break;
                }
            }
    ...
    public void setLoadMoreFooterView(View view) {
        if (view instanceof SwipeLoadMoreTrigger) {
            ...
            if (mFooterView != view) {
                ...
                addView(mFooterView, new MarginLayoutParams(MarginLayoutParams.MATCH_PARENT, mFooterView.getHeight()));
            }
        } else {
